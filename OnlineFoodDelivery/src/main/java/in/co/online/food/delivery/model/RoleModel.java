...
public class RoleModel 
{
    ...
    public Integer nextPK() throws DatabaseException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("SELECT MAX(ID) FROM OF_ROLE");
    ...
    public long add(RoleBean bean) throws ApplicationException,
        ...
        try {
            ...
            //accessing data and putting in to Database objects
            PreparedStatement pstmt = conn
                    .prepareStatement("INSERT INTO OF_ROLE VALUES(?,?,?,?,?,?,?)");
            pstmt.setInt(1, pk);
     ...
     */
	    public void delete(RoleBean bean) throws ApplicationException {
	        ...
	        try {
	            ...
	            conn.setAutoCommit(false); // Begin transaction
	            PreparedStatement pstmt = conn
	                    .prepareStatement("DELETE FROM OF_ROLE WHERE ID=?");
    ...
    public RoleBean findByName(String name) throws ApplicationException {
        ...
        StringBuffer sql = new StringBuffer(
                "SELECT * FROM OF_ROLE WHERE NAME=?");
        RoleBean bean = null;
        Connection conn = null;
        try {
            conn = JDBCDataSource.getConnection();
    ...
    public void update(RoleBean bean) throws ApplicationException,
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE OF_ROLE SET NAME=?,DESCRIPTION=?,CREATEDBY=?,MODIFIEDBY=?,CREATEDDATETIME=?,MODIFIEDDATETIME=? WHERE ID=?");
    ...
    public List search(RoleBean bean, int pageNo, int pageSize)
        ...
        StringBuffer sql = new StringBuffer("SELECT * FROM OF_ROLE WHERE 1=1");
        if (bean != null) {
            if (bean.getId() > 0) {
