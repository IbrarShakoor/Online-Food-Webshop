...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		//As i don't have my Domain name and also my future company Description or Credentials .It is just a sample.
msg.append("Registration is successful for Java Project IS Technologies");
		msg.append("<H1>Hi! Greetings from IS Technologies!</H1>");
		msg.append(
				"<P>Congratulations for registering on IS! You can now access your IS account online - anywhere, anytime and  enjoy the flexibility to check the Marksheet Details.</P>");
		msg.append(
				"<P>Log in today at <a href='http://ors.ISTechnologies.com'>http://ors.ISTechnologies.com</a> with your following credentials:</P>");
		...
		msg.append("<p>You may also write to us at Ibrar.Shakoor@ibm.com</p>");
		msg.append(
				"<p>We assure you the best service at all times and look forward to a warm and long-standing association with you.</p>");
		msg.append("<P><a href='http://www.ISTechnologies.co.in' >-IS Technolgies</a></P>");
		msg.append("</BODY></HTML>");
		

	
		//Sample after user decide to reset his/her password		
		/* msg.append("<HTML><BODY>");
		msg.append("Registration is successful for ORS Project IS Technologies");
