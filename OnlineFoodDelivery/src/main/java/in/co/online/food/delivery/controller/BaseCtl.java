...
{
	/*HttpServlet implementing the servler class which serve the HTTP request*/
	
	private static final Logger log=Logger.getLogger(BaseCtl.class);//Here we are creating the logger if it's exist then fine otherwise create new
	
	
	
	/*All of the string var which we going to use to perform operations*/
	...
	protected BaseBean populateDTO(BaseBean dto, HttpServletRequest request) {//We are checking and storing in the database who is creating the account
