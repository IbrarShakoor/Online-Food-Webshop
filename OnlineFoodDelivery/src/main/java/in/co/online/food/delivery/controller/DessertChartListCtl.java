...
/**
 * Servlet implementation class DessertChartChartListCtl
 */
@WebServlet(name = "DessertChartListCtl", urlPatterns = { "/ctl/DessertChartListCtl" })
public class DessertChartListCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		DessertChartBean bean = (DessertChartBean) populateBean(request);
		...
		try {
			...
			if(dsid > 0) {
				...
				DessertChartBean deletebean = new DessertChartBean();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || "Next".equalsIgnoreCase(op) || "Previous".equalsIgnoreCase(op)) {
				...
				ServletUtility.redirect(OFDView.DESSERT_CHART_LIST_CTL, request, response);
				return;
			}
	...
	protected String getView() {
		...
		return OFDView.DESSERT_CHART_LIST_VIEW;
