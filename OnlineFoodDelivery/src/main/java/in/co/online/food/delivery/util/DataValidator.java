...
public class DataValidator {
	...
	public static boolean isName(String val) {
		...
		String name = "^[A-Za-z ]*$";//Range from a,,,z andA,,,,Z .^ means start of the line, /& means end of the line
		/*
	...
	public static void main(String[] args) {
		...
		//Passing arguments just to checks if teh upper functions are working or not
