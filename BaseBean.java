...
/**
 * BaseBean JavaBean (Abstract class,Parent Class)
 * 
...
/*Java provide Comparable interface to sort things,so we use here*/
public abstract class BaseBean implements DropdownListBean, Comparable<BaseBean> {  
	...
	public int compareTo(BaseBean next) {
		// TODO Auto-generated method stub-It will automatically create the next value
